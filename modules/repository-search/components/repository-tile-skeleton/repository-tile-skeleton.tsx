    ...
    >
      <div className="p-6">
        <div className="mb-4 flex items-center">
          <div
            className="mr-3 h-10 w-10 rounded-full bg-gray-700"
            aria-hidden="true"
          />
          <div className="flex-1">
            <div
              ...
              aria-hidden="true"
            />
            <div className="h-4 w-1/3 rounded bg-gray-700" aria-hidden="true" />
          </div>
        </div>

        <div className="mb-4 space-y-2">
          <div className="h-4 w-full rounded bg-gray-700" aria-hidden="true" />
          <div className="h-4 w-4/5 rounded bg-gray-700" aria-hidden="true" />
        </div>
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between border-t border-gray-700 pt-4">
          <div className="flex items-center">
            <div
              className="mr-2 h-3 w-3 rounded-full bg-gray-700"
              aria-hidden="true"
            />
            <div className="h-4 w-16 rounded bg-gray-700" aria-hidden="true" />
          </div>
          ...
          <div className="flex items-center space-x-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center">
                <div
                  className="mr-1 h-4 w-4 rounded bg-gray-700"
                  aria-hidden="true"
                />
                <div
                  className="h-4 w-12 rounded bg-gray-700"
                  aria-hidden="true"
                />
              </div>
            ))}
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="h-4 w-32 rounded bg-gray-700" aria-hidden="true" />
          <div className="h-4 w-24 rounded bg-gray-700" aria-hidden="true" />
        </div>
      </div>
    </article>
  );
